...
import (
	...
	//      // A solid scripting workflow is a really big deal for this
	//      // project. The goal is for a language approx to Go itself.
	//      // I'm hoping to be able to run Yaegi ... but don't know if
	//      // it is fast-enough for this usecase. Tengo is another
	//      // interesting option worth considering, I think.
	//
...
func initGL(w, h int) *glfw.Window {
	...
	win, err := glfw.CreateWindow(w, h, "DELTΔ", nil, nil)
	if err != nil {
		log.Fatal(err)
	}
